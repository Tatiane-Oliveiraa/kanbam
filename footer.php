...
<footer style="background:#126a97; color:#fff; text-align:center; padding:20px 0; position:fixed; bottom:0; left:0; width:100%;">
    <p>&copy; 2025 -  Projeto Planix | Todos os direitos reservados.</p>
    ...
    <div style="margin:15px 0;">
        <a href="https://www.instagram.com/jao_lucas_s" target="_blank" style="margin:0 10px; text-decoration:none; color:#fff;">
            ...
            <a href="https://www.instagram.com/tati.cristina01" target="_blank" style="margin:0 10px; text-decoration:none; color:#fff;">
